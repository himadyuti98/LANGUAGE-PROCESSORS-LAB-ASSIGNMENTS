...
#line 126 "parse.tab.c" /* yacc.c:355  */
};
...
{
  "$end", "error", "$undefined", "EOL", "'a'", "'b'", "$accept", "S", "E", YY_NULLPTR
};
#endif
...
#line 26 "parse.y" /* yacc.c:1646  */
    {printf("yaas"); if((yyvsp[-1].e)->type==1) printf("valid\n"); else printf("invalid\n"); printf(">");}
